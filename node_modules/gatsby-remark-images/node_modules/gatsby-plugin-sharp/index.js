      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 11:
            ...
            pipeline.resize(options.width, options.height).crop(validateCropFocus(options)).png({
...
var validateCropFocus = function validateCropFocus(options) {
  return (!options.width || !options.height) && (options.cropFocus === sharp.strategy.entropy || options.cropFocus === sharp.strategy.attention) ? sharp.gravity.center : options.cropFocus;
};
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              clonedPipeline.resize(roundedWidth, roundedHeight).crop(validateCropFocus(args)).png({
